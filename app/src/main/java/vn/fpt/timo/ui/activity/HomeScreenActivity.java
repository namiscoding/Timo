...
import vn.fpt.timo.ui.adapter.FilmSliderHomeScreenAdapter;

public class HomeScreenActivity extends AppCompatActivity {
    private RecyclerView nowPlayingRecyclerView;
    private RecyclerView comingSoonRecyclerView;
    private BottomNavigationView bottomNavigation;
    private FilmCustomerService filmService;
    private EditText searchquery;
    private TextView filmsDisplayTextView;

    private FilmHomeScreenAdapter nowPlayingAdapter;
    private FilmHomeScreenAdapter comingSoonAdapter;

    private ViewPager2 viewPager2;
    private FilmSliderHomeScreenAdapter sliderAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchquery.setOnEditorActionListener((v, actionId, event) -> {
            if (actionId == EditorInfo.IME_ACTION_SEARCH ||
                ...
                if (!query.isEmpty()) {
                    ...
                    Intent intent = new Intent(HomeScreenActivity.this, vn.fpt.timo.ui.activity.findAllFilmCustomerActivity.class);
        ...
        nowPlayingAdapter = new FilmHomeScreenAdapter(new ArrayList<>());
        comingSoonAdapter = new FilmHomeScreenAdapter(new ArrayList<>());
        sliderAdapter = new FilmSliderHomeScreenAdapter(new ArrayList<>());
    ...
    public void onStartButtonClick(View view) {
        Intent intenTextview6 = new Intent(HomeScreenActivity.this, findAllFilmCustomerActivity.class);
