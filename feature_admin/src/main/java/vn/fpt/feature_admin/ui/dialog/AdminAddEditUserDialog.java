...
public class AdminAddEditUserDialog extends DialogFragment {
    ...
    public static void show(FragmentActivity activity, User user, AdminManageUsersViewModel vm) {
        AdminAddEditUserDialog dialog = new AdminAddEditUserDialog();
        dialog.user = user;
        dialog.viewModel = vm;
        dialog.show(activity.getSupportFragmentManager(), "AdminAddEditUserDialog");
    }
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View view = getLayoutInflater().inflate(R.layout.admin_dialog_add_edit_user, null);
        dialog.setView(view);
