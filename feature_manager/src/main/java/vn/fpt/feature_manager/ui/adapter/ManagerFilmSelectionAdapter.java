...
public class ManagerFilmSelectionAdapter extends RecyclerView.Adapter<ManagerFilmSelectionAdapter.FilmViewHolder>{
    private List<Film> films = new ArrayList<>();
    private final Context context;
    private OnFilmClickListener onFilmClickListener;

    public ManagerFilmSelectionAdapter(@NonNull Context context) { // Thêm @NonNull ở đây
    ...
    public FilmViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_film_selection_manager, parent, false);
    ...
    public class FilmViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(Film film) {
            ...
            Glide.with(context)
                    ...
                    .placeholder(R.drawable.ic_cinema_logo_manager)
                    .error(R.drawable.ic_cinema_logo_manager)
                    .into(ivPoster);
