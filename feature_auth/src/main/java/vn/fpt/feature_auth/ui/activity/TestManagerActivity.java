...
public class TestManagerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (currentUser != null) {
            ...
            startActivity(new Intent(TestManagerActivity.this, AllLoginActivity.class));
            finish();
            return;
        }
        ...
        authViewModel.getFirebaseUserLiveData().observe(this, firebaseUser -> {
            if (firebaseUser == null) {
                ...
                Toast.makeText(TestManagerActivity.this, "Logged out successfully.", Toast.LENGTH_SHORT).show();
