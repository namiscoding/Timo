...
public class AdminManageUserAdapter extends RecyclerView.Adapter<AdminManageUserAdapter.UserViewHolder> {
    ...
    public AdminManageUserAdapter(List<User> users, UserActionListener listener) {
        this.users = users;
    ...
    public UserViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.admin_item_manage_user, parent, false);
