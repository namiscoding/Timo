...
public class CinemaBookingAdapter  extends RecyclerView.Adapter<CinemaBookingAdapter.CinemaViewHolder> {
    ...
    public CinemaBookingAdapter(List<Cinema> cinemaList) {
    ...
    public CinemaViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_cinema_booking, parent, false);
