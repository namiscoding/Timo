...
public class AuthOptionsActivity extends AppCompatActivity {
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(AuthOptionsActivity.this, "Đăng nhập Firebase thất bại: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                            hideProgressBar();
                ...
                .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (document != null && !document.exists()) {
                                ...
                                db.collection("users").document(firebaseUser.getUid())
                                        ...
                                        .addOnSuccessListener(aVoid -> {
                                            ...
                                            Toast.makeText(AuthOptionsActivity.this, "Đăng nhập thành công!", Toast.LENGTH_SHORT).show();
                                            hideProgressBar();
                                        ...
                                        .addOnFailureListener(e -> {
                                            ...
                                            Toast.makeText(AuthOptionsActivity.this, "Lỗi lưu dữ liệu người dùng: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                            hideProgressBar();
                                            // Vẫn có thể điều hướng, nhưng có thể cân nhắc đăng xuất Firebase Auth nếu dữ liệu core bị lỗi
                                            navigateToRoleSpecificActivity("user"); // Điều hướng về mặc định nếu lỗi Firestore
                                        });
                                ...
                                if (existingUser != null && existingUser.getRole() != null) {
                                    ...
                                    if (needsUpdate) {
                                        db.collection("users").document(firebaseUser.getUid())
                                                ...
                                                .addOnFailureListener(e -> {
                                                    ...
                                                    Toast.makeText(AuthOptionsActivity.this, "Lỗi cập nhật dữ liệu người dùng: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                                    hideProgressBar();
                                    ...
                                    Toast.makeText(AuthOptionsActivity.this, "Lỗi dữ liệu người dùng, vui lòng liên hệ hỗ trợ.", Toast.LENGTH_LONG).show();
                                    hideProgressBar();
                            ...
                            Toast.makeText(AuthOptionsActivity.this, "Lỗi kiểm tra dữ liệu người dùng: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                            hideProgressBar();
                        ...
                        if (task.isSuccessful()) {
                            ...
                            if (document != null && document.exists()) {
                                ...
                                if (user != null && user.getRole() != null) {
                                    ...
                                    navigateToRoleSpecificActivity("user");
                                }
                            } else {
                                ...
                                db.collection("users").document(firebaseUser.getUid())
                                        ...
                                        .addOnFailureListener(e -> {
                                            ...
                                            Toast.makeText(AuthOptionsActivity.this, "Lỗi tải dữ liệu người dùng, vui lòng thử lại.", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(AuthOptionsActivity.this, "Không thể tải dữ liệu người dùng.", Toast.LENGTH_SHORT).show();
    ...
    private void navigateToRoleSpecificActivity(String role) {
        ...
        switch (role) {
            case "admin":
                intent = new Intent(AuthOptionsActivity.this, AdminActivity.class);
                break;
            case "manager":
                intent = new Intent(AuthOptionsActivity.this, ManagerActivity.class);
                break;
            case "user":
            default: // Mặc định nếu không có role hoặc role không xác định
                intent = new Intent(AuthOptionsActivity.this, UserActivity.class);
                break;
        }
        startActivity(intent);
        finish();
