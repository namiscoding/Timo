...
public class findAllActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        filmAdapter.setOnItemClickListener(film -> {
            ...
            Toast.makeText(findAllActivity.this, "Film clicked: " + film.getTitle(), Toast.LENGTH_SHORT).show();
                ...
                .thenAccept(films -> {
                    runOnUiThread(() -> {
                        ...
                        if (nowPlayingFilms.isEmpty()) {
                            Toast.makeText(findAllActivity.this, "Không có phim đang chiếu để hiển thị.", Toast.LENGTH_LONG).show();
                        }
                    });
                })
                .exceptionally(e -> {
                    runOnUiThread(() -> {
                        hideLoadingState();
                        Toast.makeText(findAllActivity.this, "Lỗi khi tải phim: " + e.getMessage(), Toast.LENGTH_LONG).show();
