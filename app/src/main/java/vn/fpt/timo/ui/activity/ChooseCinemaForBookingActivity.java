...
import vn.fpt.timo.data.firestore_services.CinemaCustomerService;
import vn.fpt.timo.data.models.Cinema;
import vn.fpt.timo.ui.adapter.CinemaBookingAdapter;
import vn.fpt.timo.ui.adapter.DateAdapter;

public class ChooseCinemaForBookingActivity extends AppCompatActivity {
    ...
    private CinemaBookingAdapter cinemaAdapter;
    private CinemaCustomerService cinemaService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cinemaService = new CinemaCustomerService();
        ...
        cinemaAdapter = new CinemaBookingAdapter(new ArrayList<>());
        ...
        cinemaAdapter.setOnItemClickListener(new CinemaBookingAdapter.OnItemClickListener() {
            ...
            public void onFavoriteClick(Cinema cinema, ImageView starIcon) {
                ...
                Toast.makeText(ChooseCinemaForBookingActivity.this, cinema.getName() + (cinema.isActive() ? " đã thêm vào yêu thích" : " đã gỡ khỏi yêu thích"), Toast.LENGTH_SHORT).show();
            }
        });
