...
public class AdminAddEditFilmDiaglog extends DialogFragment {
    ...
    public static void show(FragmentActivity activity, Film film, AdminManageFilmsViewModel vm) {
        AdminAddEditFilmDiaglog dialog = new AdminAddEditFilmDiaglog();
        dialog.film = film;
        dialog.viewModel = vm;
        dialog.show(activity.getSupportFragmentManager(), "AdminAddEditFilmDiaglog");
    }
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View view = getLayoutInflater().inflate(R.layout.admin_dialog_add_edit_film, null);
        dialog.setView(view);
