...
public class FilmSliderHomeScreenAdapter extends RecyclerView.Adapter<FilmSliderHomeScreenAdapter.FilmSliderViewHolder> {
    ...
    public FilmSliderHomeScreenAdapter(List<Film> films) {
