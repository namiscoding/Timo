...
public class CustomerFilmSliderAdapter extends RecyclerView.Adapter<CustomerFilmSliderAdapter.FilmSliderViewHolder> {
    ...
    public CustomerFilmSliderAdapter(List<Film> films) {
