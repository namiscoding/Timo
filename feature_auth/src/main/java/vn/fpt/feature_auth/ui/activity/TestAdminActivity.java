...
public class TestAdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            new AlertDialog.Builder(this, R.style.CustomAlertDialogTheme)
                    ...
                    .setPositiveButton("Lưu", (dialog, which) -> {
                        ...
                        if (!newDisplayName.isEmpty()) {
                            ...
                            Toast.makeText(TestAdminActivity.this, "Tên hiển thị không được để trống.", Toast.LENGTH_SHORT).show();
                        }
                    })
        ...
        btnNavigateToCustomerIntro.setOnClickListener(v -> {
            Intent intent = new Intent(TestAdminActivity.this, AdminDashboardActivity.class);
        ...
        authViewModel.getFirebaseUserLiveData().observe(this, firebaseUser -> {
            if (firebaseUser == null) {
                Toast.makeText(TestAdminActivity.this, "Đã đăng xuất thành công.", Toast.LENGTH_SHORT).show();
        ...
        authViewModel.getResultMessageLiveData().observe(this, message -> {
            if (message != null && !message.isEmpty()) {
                Toast.makeText(TestAdminActivity.this, message, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        authViewModel.getDisplayNameUpdateSuccessLiveData().observe(this, newDisplayName -> {
            if (newDisplayName != null && !newDisplayName.isEmpty()) {
                String welcomeText = "Xin chào, Admin " + newDisplayName + "!";
    ...
    private void loadUserData() {
        ...
        if (currentUser != null) {
            String welcomeText = "Xin chào, Admin " + (currentUser.getDisplayName() != null ? currentUser.getDisplayName() : currentUser.getEmail()) + "!";
