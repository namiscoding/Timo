...
public class AdminCinemaAdapter extends RecyclerView.Adapter<AdminCinemaAdapter.AdminCinemaViewHolder> {
    public interface AdminCinemaActionListener {
        void onEdit(Cinema cinema);
        void onToggleStatus(Cinema cinema);
    }

    private final List<Cinema> cinemas;
    private final AdminCinemaActionListener listener;

    public AdminCinemaAdapter(List<Cinema> cinemas, AdminCinemaActionListener listener) {
    ...
    @NonNull
    @Override
    public AdminCinemaViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_cinema, parent, false);
        return new AdminCinemaViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdminCinemaViewHolder holder, int position) {
    ...
    static class AdminCinemaViewHolder extends RecyclerView.ViewHolder {
        TextView name, address, city, status;
        Button editBtn, toggleStatusBtn;

        AdminCinemaViewHolder(View view) {
            super(view);
