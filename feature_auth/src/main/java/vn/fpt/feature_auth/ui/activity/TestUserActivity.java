...
public class TestUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (currentUser != null) {
            String welcomeText = "Welcome, Customer " + (currentUser.getDisplayName() != null ? currentUser.getDisplayName() : currentUser.getEmail()) + "!";
            tvWelcomeMessage.setText(welcomeText);
        } else {
            // Nếu không có người dùng, chuyển về màn hình Login
            startActivity(new Intent(TestUserActivity.this, AllLoginActivity.class));
            finish();
            return;
        }
        ...
        authViewModel.getFirebaseUserLiveData().observe(this, firebaseUser -> {
            if (firebaseUser == null) {
                ...
                Toast.makeText(TestUserActivity.this, "Logged out successfully.", Toast.LENGTH_SHORT).show();
