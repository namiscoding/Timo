...
//import vn.fpt.timo.ui.adapter.StringListAdapter;
//
...
//
//                        } else {
//                            Toast.makeText(FilmDetailActivity.this, "Không tìm thấy phim với ID này.", Toast.LENGTH_LONG).show();
...
//                    runOnUiThread(() -> {
//                        hideLoadingState();
//                        Toast.makeText(FilmDetailActivity.this, "Lỗi khi tải chi tiết phim: " + e.getMessage(), Toast.LENGTH_LONG).show();
