...
public class TestManagerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            new AlertDialog.Builder(this, R.style.CustomAlertDialogTheme)
                    ...
                    .setPositiveButton("Lưu", (dialog, which) -> {
                        ...
                        if (!newDisplayName.isEmpty()) {
                            ...
                            Toast.makeText(TestManagerActivity.this, "Tên hiển thị không được để trống.", Toast.LENGTH_SHORT).show();
                        }
                    })
        ...
        btnNavigateToCustomerIntro.setOnClickListener(v -> {
            Intent intent = new Intent(TestManagerActivity.this, ManagerHomePageActivity.class);
        ...
        authViewModel.getFirebaseUserLiveData().observe(this, firebaseUser -> {
            if (firebaseUser == null) {
                Toast.makeText(TestManagerActivity.this, "Đã đăng xuất thành công.", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(TestManagerActivity.this, AllLoginGGActivity.class));
                finish();
            } else {
        ...
        authViewModel.getResultMessageLiveData().observe(this, message -> {
            if (message != null && !message.isEmpty()) {
                Toast.makeText(TestManagerActivity.this, message, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        authViewModel.getDisplayNameUpdateSuccessLiveData().observe(this, newDisplayName -> {
            if (newDisplayName != null && !newDisplayName.isEmpty()) {
                String welcomeText = "Xin chào, Manager " + newDisplayName + "!";
    ...
    private void loadUserData() {
        ...
        if (currentUser != null) {
            String welcomeText = "Xin chào, Manager " + (currentUser.getDisplayName() != null ? currentUser.getDisplayName() : currentUser.getEmail()) + "!";
